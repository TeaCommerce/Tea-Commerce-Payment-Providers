...
namespace TeaCommerce.PaymentProviders.Web.PayExService {
    using System;
    ...
    public partial class PxOrder : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void CalculateLoanAsync(long accountNumber, int numberOfMonths, int monthlyPayment, long amount, int loanType, string hash) {
            this.CalculateLoanAsync(accountNumber, numberOfMonths, monthlyPayment, amount, loanType, hash, null);
        }
        
        /// <remarks/>
        public void CalculateLoanAsync(long accountNumber, int numberOfMonths, int monthlyPayment, long amount, int loanType, string hash, object userState) {
