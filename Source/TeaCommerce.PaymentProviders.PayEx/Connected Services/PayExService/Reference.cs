...
namespace TeaCommerce.PaymentProviders.PayExService {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://external.payex.com/PxOrder/", ConfigurationName="PayExService.PxOrderSoap")]
    public interface PxOrderSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string CheckTransaction(long accountNumber, string OrderId, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse AddMultipleOrderLines(TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://external.payex.com/PxOrder/AddMultipleOrderLines", ReplyAction="*")]
        System.Threading.Tasks.Task<TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse> AddMultipleOrderLinesAsync(TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string PurchaseCreditAccount(long accountNumber, string orderRef, string socialSecurityNumber, string legalName, string streetAddress, string coAddress, string zipCode, string city, string countryCode, string paymentMethod, string email, string msisdn, string ipAddress, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string PreparePurchasePremiumSms(long accountNumber, string orderRef, string msisdn, string message, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string AccomplishPremiumSms(long accountNumber, string orderRef, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string PurchasePremiumSms(long accountNumber, string orderRef, string msisdn, string message, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string CheckMsisdn(long accountNumber, string msisdn, int amount, string vasAgreementId, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string SendSmsCode(long accountNumber, string sender, string msIsdn, string customData, string vasAgreementId, string hash);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string VerifySmsCodeStatus(long accountNumber, string orderRef, string smsCode, string hash);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface PxOrderSoapChannel : TeaCommerce.PaymentProviders.PayExService.PxOrderSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PxOrderSoapClient : System.ServiceModel.ClientBase<TeaCommerce.PaymentProviders.PayExService.PxOrderSoap>, TeaCommerce.PaymentProviders.PayExService.PxOrderSoap {
        ...
        public string CheckTransaction(long accountNumber, string OrderId, string hash) {
            return base.Channel.CheckTransaction(accountNumber, OrderId, hash);
        }
        ...
        public string PreparePurchaseSwish(long accountNumber, string orderRef, string msisdn, string ipAddress, string hash) {
            return base.Channel.PreparePurchaseSwish(accountNumber, orderRef, msisdn, ipAddress, hash);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse TeaCommerce.PaymentProviders.PayExService.PxOrderSoap.AddMultipleOrderLines(TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest request) {
        ...
        public string AddMultipleOrderLines(long accountNumber, string orderRef, int numberOfItems, string[][] orderDetails, string hash) {
            TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest inValue = new TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest();
            ...
            inValue.hash = hash;
            TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse retVal = ((TeaCommerce.PaymentProviders.PayExService.PxOrderSoap)(this)).AddMultipleOrderLines(inValue);
            return retVal.AddMultipleOrderLinesResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse> TeaCommerce.PaymentProviders.PayExService.PxOrderSoap.AddMultipleOrderLinesAsync(TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest request) {
            return base.Channel.AddMultipleOrderLinesAsync(request);
        }
        
        public System.Threading.Tasks.Task<TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesResponse> AddMultipleOrderLinesAsync(long accountNumber, string orderRef, int numberOfItems, string[][] orderDetails, string hash) {
            TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest inValue = new TeaCommerce.PaymentProviders.PayExService.AddMultipleOrderLinesRequest();
            inValue.accountNumber = accountNumber;
            inValue.orderRef = orderRef;
            inValue.numberOfItems = numberOfItems;
            inValue.orderDetails = orderDetails;
            inValue.hash = hash;
            return ((TeaCommerce.PaymentProviders.PayExService.PxOrderSoap)(this)).AddMultipleOrderLinesAsync(inValue);
        }
        ...
        public string PurchaseCreditAccount(long accountNumber, string orderRef, string socialSecurityNumber, string legalName, string streetAddress, string coAddress, string zipCode, string city, string countryCode, string paymentMethod, string email, string msisdn, string ipAddress, string hash) {
            return base.Channel.PurchaseCreditAccount(accountNumber, orderRef, socialSecurityNumber, legalName, streetAddress, coAddress, zipCode, city, countryCode, paymentMethod, email, msisdn, ipAddress, hash);
        }
        ...
        public string PreparePurchasePremiumSms(long accountNumber, string orderRef, string msisdn, string message, string hash) {
            return base.Channel.PreparePurchasePremiumSms(accountNumber, orderRef, msisdn, message, hash);
        }
        ...
        public string AccomplishPremiumSms(long accountNumber, string orderRef, string hash) {
            return base.Channel.AccomplishPremiumSms(accountNumber, orderRef, hash);
        }
        ...
        public string PurchasePremiumSms(long accountNumber, string orderRef, string msisdn, string message, string hash) {
            return base.Channel.PurchasePremiumSms(accountNumber, orderRef, msisdn, message, hash);
        }
        ...
        public string CheckMsisdn(long accountNumber, string msisdn, int amount, string vasAgreementId, string hash) {
            return base.Channel.CheckMsisdn(accountNumber, msisdn, amount, vasAgreementId, hash);
        }
        ...
        public string SendSmsCode(long accountNumber, string sender, string msIsdn, string customData, string vasAgreementId, string hash) {
            return base.Channel.SendSmsCode(accountNumber, sender, msIsdn, customData, vasAgreementId, hash);
        }
        ...
        public string VerifySmsCodeStatus(long accountNumber, string orderRef, string smsCode, string hash) {
            return base.Channel.VerifySmsCodeStatus(accountNumber, orderRef, smsCode, hash);
        }
