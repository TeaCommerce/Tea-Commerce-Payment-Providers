...
namespace TeaCommerce.PaymentProviders.Classic {
  ...
  [PaymentProvider( "SagePay3" )]
  public class SagePay3 : APaymentProvider {
    ...
    private const string VPSProtocolVersion = "3.00";
    ...
    public override IDictionary<string, string> DefaultSettings {
      get {
        ...
        defaultSettings["Apply3DSecure"] = "0";
        defaultSettings["ApplyAVSCV2"] = "0";
    ...
    public override PaymentHtmlForm GenerateHtmlForm( Order order, string teaCommerceContinueUrl, string teaCommerceCancelUrl, string teaCommerceCallBackUrl, string teaCommerceCommunicationUrl, IDictionary<string, string> settings ) {
      ...
      inputFields["VPSProtocol"] = VPSProtocolVersion;
      ...
      inputFields["Apply3DSecure"] = settings.ContainsKey("Apply3DSecure") ? settings["Apply3DSecure"] : "0";
    ...
    public override CallbackInfo ProcessCallback( Order order, HttpRequest request, IDictionary<string, string> settings ) {
      ...
      try {
        ...
        md5CheckValue += request.Form["DeclineCode"];
        md5CheckValue += request.Form["ExpiryDate"];
        md5CheckValue += request.Form["FraudResponse"];
        md5CheckValue += request.Form["BankAuthCode"];
    ...
    public override ApiInfo CapturePayment( Order order, IDictionary<string, string> settings ) {
      ...
      try {
        ...
        inputFields["ApplyAVSCV2"] = settings.ContainsKey("ApplyAVSCV2") ? settings["ApplyAVSCV2"] : "0";
    ...
    public override string GetLocalizedSettingsKey( string settingsKey, CultureInfo culture ) {
      switch ( settingsKey ) {
        ...
        case "Apply3DSecure":
          return settingsKey + "<br/><small>0, 1, 2, 3 (see docs)</small>";
        case "ApplyAVSCV2":
          return settingsKey + "<br/><small>0, 1, 2, 3 (see docs)</small>";
        default:
