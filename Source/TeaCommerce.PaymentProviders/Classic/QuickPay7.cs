...
namespace TeaCommerce.PaymentProviders.Classic {
  [PaymentProvider( "QuickPay7" )]
  public class QuickPay7 : APaymentProvider {

    public override string DocumentationLink { get { return "https://documentation.teacommerce.net/guides/payment-providers/quickpay-v7/"; } }
